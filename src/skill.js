import { POLL_SEND_AND_END_RULE, POLL_WAKE_PATH_RULES, RENDER_VERIFY_RULE, createHomeOutput } from "./cli.js";
...
2. ${skillCommandText(RENDER_VERIFY_RULE)}
...
8. ${POLL_SEND_AND_END_RULE} Deliver any remaining updates directly in this conversation.
