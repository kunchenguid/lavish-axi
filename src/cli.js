...
const COMMAND_HELP = {
  ...
  design: `Usage: lavish-axi design\n\nShow a copy-pasteable CDN snippet for Tailwind CSS browser runtime v4 + DaisyUI v5 + themes, plus technical reference for DaisyUI components. Lavish artifacts stay portable HTML; paste the snippet into the artifact's <head> only if you want the DaisyUI design system. Other design systems and plain HTML are also fine.\n`,
