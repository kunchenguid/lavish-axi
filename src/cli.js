...
import { createDesignOutput, DESIGN_PRIORITY_RULE, DESIGN_SYSTEM_HINT, SELF_PAINT_RULE } from "./design-reference.js";
import {
...
// Owns the render-verify step of the authoring workflow: verifying the inputs of a page is not
// verifying the page, and a served session URL must never be the verification target because
// every chrome load supersedes the current reviewer (see issueReviewerHandoff), which would
// silently take the review away from the user's open tab.
export const RENDER_VERIFY_RULE =
