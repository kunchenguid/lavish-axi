...
export class SessionStore {
  constructor(file) {
    this.file = file;
    // Serializes every read-modify-write. The browser POSTs prompts and layout
    // scans while a waiting poll drains concurrently; without this, whichever
    // write landed last erased the other's mutation, and a user prompt queued
