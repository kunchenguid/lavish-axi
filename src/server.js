...
<div class="ended-overlay" id="endedOverlay" hidden><div class="ended-card"><div class="ended-unsent" id="endedUnsentWarning" role="alert" hidden><strong>Unsent feedback was not delivered.</strong><span>Copy it now and return it to your agent manually.</span><button class="button ended-unsent-copy" id="endedUnsentCopy" type="button">Copy unsent feedback</button></div><div class="ended-title">Session ended.<br>Return to your agent to continue.</div><p class="ended-copy">${escapeHtml(session.file)}</p></div></div>
