...
const chromeIcons = {
  ...
  chevronDown: chromeIcon('<polyline points="6 9 12 15 18 9"/>', 14),
  refresh: chromeIcon(
...
<button class="reader-restore" id="readerRestore" type="button" hidden aria-label="Show Lavish controls">${chromeIcons.chevronDown}<span>Controls</span></button>
...
const isKeyboardEntryElement=${isKeyboardEntryElement.toString()};
...
const isPlainEscapeEvent=${isPlainEscapeEvent.toString()};
