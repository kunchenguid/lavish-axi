...
const chromeIcons = {
  conversation: `${chromeIcon(
    '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M15 4v16"/><path d="m11 9-3 3 3 3"/>',
    17,
  ).replace("<svg ", '<svg class="conversation-icon-hide" ')}${chromeIcon(
    '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M15 4v16"/><path d="m8 9 3 3-3 3"/>',
    17,
  ).replace("<svg ", '<svg class="conversation-icon-show" ')}`,
  more: chromeIcon(
