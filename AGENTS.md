...
- Nothing deletes an attachment except the reference-aware sweeper. No iframe-driven delete. Cap admission goes through `admitAttachmentCharge` and charges allocated blocks. [Image attachments](docs/invariants.md#image-attachments).
