...
- **Reusable artifacts** - Agents can search reusable components and recipes before they write HTML. They pass compact TOON content to a composer instead of repeating component markup and design tokens.
...
| `lavish-axi registry ...`       | Search, inspect, create, register, import, or remove reusable artifact components.                                                                                                                                                                                                                                                           |
| `lavish-axi recipe ...`         | Inspect and operate page recipes, slots, component rules, and design tokens.                                                                                                                                                                                                                                                                 |
| `lavish-axi compose ...`        | Compose a complete HTML artifact from a recipe and compact TOON or JSON component calls.                                                                                                                                                                                                                                                     |
