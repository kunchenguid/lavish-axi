...
- **Keyboard shortcuts** - In the chrome composer, Enter sends queued prompts and Shift+Enter inserts a newline; the thread reply composer follows the same convention, with Enter sending the reply.
