...
| `lavish-axi share <html-file>`  | Publish the artifact (local assets inlined) to [ht-ml.app](https://ht-ml.app) and print a public, visitable URL anyone can open (plus a secret update key). Everything published is public. |
