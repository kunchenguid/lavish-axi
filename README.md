...
| `lavish-axi poll`        | `--owner <label>`           | Identify the process listening for this session; the label appears in the home session listing. A second concurrent poll is refused instead of silently returning `waiting`.                                                                                                                                                  |
