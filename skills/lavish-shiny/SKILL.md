...
2. **Launch Shiny app in Lavish**: Run `npx -y lavish-axi shiny <app-dir>`. If the app is already running on a specific port, run `npx -y lavish-axi shiny <app-dir> --url <url>`.
